...
class AppComponent {
    constructor(wService) {
        ...
        this.nombre = 'Elías Roblero Pérez';
        this.title = 'cliente';
    }
}
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 2, consts: [[1, "p-2", "bg-dark", "text-white", "yext-right"], ["class", "text-success", 4, "ngIf"], ["class", "text-danger", 4, "ngIf"], [1, "text-success"], [1, "text-danger"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.wService.socketStatus);
...
const environment = {
    production: false,
    wsUrl: 'http://54.145.193.88:7000'
};
//'http://54.145.193.88:7000'
/*
...
module.exports = __webpack_require__(/*! C:\Users\computo\Documents\DjangoClassroom\cliente\src\main.ts */"./src/main.ts");
